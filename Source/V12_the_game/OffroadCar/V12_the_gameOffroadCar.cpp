...
#include "V12_the_gameOffroadCar.h"
#include "V12_the_gameOffroadWheelFront.h"
#include "V12_the_gameOffroadWheelRear.h"
...
AV12_the_gameOffroadCar::AV12_the_gameOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UV12_the_gameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UV12_the_gameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UV12_the_gameOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UV12_the_gameOffroadWheelRear::StaticClass();
